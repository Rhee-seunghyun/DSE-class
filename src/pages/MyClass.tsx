          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                disabled={!newClassTitle || !newClassDate || !newClassCapacity || createClassMutation.isPending}
              >
        ...
        {lecturesLoading ? (
          ...
          <div className="flex gap-2 flex-wrap">
            {lectures.map((lecture) => (
              <Button
                key={lecture.id}
                variant={selectedLectureId === lecture.id ? "default" : "outline"}
                  ...
                  <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="studentLicense"
                          value={studentLicense}
                          onChange={(e) => setStudentLicense(e.target.value)}
                          placeholder="12345"
                        />
                      </div>
                    </div>
